...
public class SlotEquipUI : MonoBehaviour, IPointerDownHandler
{
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        if (nowItem != null)
        {
            ...
            BackPackPanel.chooseInventoryType = InventoryType.Equip;//表示选中的是背包的物品
